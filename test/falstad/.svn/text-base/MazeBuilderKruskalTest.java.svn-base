 ...
 * @author aablohm
 *
 *This class provides a series of black box tests for MazeBuilderKruskal.  It extends MazeBuilderTest.  It tests that the maze is generated properly both regularly
 *and deterministically.  It also tests that the maze is always bounded properly and that there is always an exit from any cell
 *in the maze.
 */
public class MazeBuilderKruskalTest extends MazeBuilderTest{
	...
	public void testDeterministicMaze() {
		MazeBuilderKruskalTest maze1 = new MazeBuilderKruskalTest(); 
		maze1.build(1);
		

		MazeBuilderKruskalTest maze2 = new MazeBuilderKruskalTest();
		maze2.build(1);
	...
	public void testMazeBoundedProperly(){
		MazeBuilderKruskalTest maze = new MazeBuilderKruskalTest();
		maze.init();
		maze.build(5);
	...
	public void testAlwaysAWayOut(){
		...
		mazebuilder2 = new MazeBuilderKruskal();
		MazeBuilderKruskalTest maze1 = new MazeBuilderKruskalTest();
		maze1.init();
		...
		mazebuilder2 = new MazeBuilderKruskal(true);
		MazeBuilderKruskalTest maze2 = new MazeBuilderKruskalTest();
		maze2.init();
		maze2.build(0);
